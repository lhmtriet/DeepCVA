...
def extract_features(start_n_gram, end_n_gram, token_pattern=None, vocabulary=None):
	return TfidfVectorizer(stop_words=None, ngram_range=(1, 1), use_idf=False, min_df=0.0, max_df=1.0, max_features=10000, norm=None, smooth_idf=False, lowercase=False, token_pattern=token_pattern, vocabulary=vocabulary)
